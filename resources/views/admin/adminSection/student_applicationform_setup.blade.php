                  ...
                  <table class="table table-bordered">
                    <thead>
                      <tr>
                        ...
                        <th class="pro-name">lebel name</th>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <form action="{{route('deleteStudentFormField')}}" method="post">
                            @csrf
                                  ...
                                  <form action="" class="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                      <div class="">
                                        ...
                                        <input name="update_relatedField" id="update_relatedField" value="{{ $field->relatedField }}" disabled></br>


                                        <label for="update_labelName">label name</label><br>
                                        <input type="text" id="update_labelName" name="update_labelName" value="{{$field->labelName}}" class="col-12"><br><br>
