                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 form-group"><!---------Required-->
                                            ...
                                            <input type="file" id="photo" name="photo" class="form-control form-light" placeholder="in English">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 form-group"><!---------Required-->
                                            <label for="">CV</label>
                                            <input type="file" id="cv" name="cv" class="form-control form-light" placeholder="in English">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 form-group"><!---------Required-->
                                            ...
                                            <textarea type="text" id="cover_Let" name="cover_Let" class="form-control form-light" placeholder="in English"></textarea>
