                                                                    ...
                                                                    <form action="" class="d-flex flex-column" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                <div class="form-control-wrap">
                                                                                    ...
                                                                                    <lebel for="class">Choose class</lebel>
                                                                                    <select name="class" id="update-class" class="col-12">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                <div class="form-control-wrap">
                                                                                    <lebel for="section">Choose section</lebel>
                                                                                    <select name="section" id="update-section" class="col-12">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                <div class="form-control-wrap">
                                                                                    <lebel for="teacher">Choose teacher</lebel>
                                                                                    <select name="teacher" id="update-teacher" class="col-12">
                                                                                    <option data-display="{{$item->teacher_id}}">{{'tcr'.$item->teacher_id}}</option>
                                                                                        @if($teachers)
                                                                                        @foreach($teachers as $i)
                                                                                        <option value="{{$i->id}}">{{$i->teacherId}}</option>
                                                                                        @endforeach
                                                                                        @endif
                                                                                    </select>
                                                                                </div>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                <div class="form-control-wrap">
                                                                                    <lebel for="subject">Choose subject</lebel>
                                                                                    <select name="subject" id="update-subject" class="col-12">
